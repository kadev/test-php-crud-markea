 ...
 * "/application" or other folder inside your application or call any other .php file than _index.php inside "/public".
 *
 * URL_PROTOCOL:
...
define('DB_NAME', 'lideraz3_manage_reservations');
define('DB_USER', 'lideraz3_markea');
define('DB_PASS', 'ek2bMmfNA;!g');
